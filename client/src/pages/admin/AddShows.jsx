     ...
     <p className='mt-10 text-lg font-medium'>Now Playing movies</p>
      ...
      <div className='mt-8'>
          ...
          <div className='inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md'>
            ...
            <input min={0} type="number" className='outline-none' placeholder='Enter show price' value={showPrice} onChange={(e) => setShowPrice(e.target.value)}/>
          </div>
      </div>
      {/* Date & Time Selection */}
      <div className='mt-6'>
        <label className='block text-sm font-medium mb-2'>Select Date and Time</label>
        <div className='inline-flex items-center gap-5 border border-gray-600 p-1 pl-2 rounded-lg'>
